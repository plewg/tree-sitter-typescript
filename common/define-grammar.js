...
module.exports = function defineGrammar(dialect) {
  return grammar(JavaScript, {
    ...
    rules: {
        ...
        seq(
          ...
          choice(
            ...
            seq(
              field(
                'name',
                choice($._module_export_name, alias('type', $.identifier)),
              ),
              'as',
      ...
      as_expression: ($) =>
        prec.left('binary', seq($.expression, 'as', choice('const', $._type))),
      ...
      infer_type: ($) =>
        prec.right(
          seq('infer', $._type_identifier, optional(seq('extends', $._type))),
        ),
